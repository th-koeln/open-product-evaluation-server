        ...
        <b-form-row
          ...
          <b-col cols="8" sm="9" md="10">
           <b-form-group label="Label"
                         ...
                         :label-sr-only="true">
             <b-input-group>
               <b-input v-model="choice.label"
                        placeholder="Label"
                        :id="`choice_label_${choice.id}`"
               ...
               <b-form-file class="file_upload"
                            ...
                            :id="`file_upload_choice_${choice.id}`"
                            accept="image/*"
           ...
           <b-form-group label="Code"
                         ...
                         :label-sr-only="true">
             <b-input placeholder="Code"
                      @change="updateChoice(question, choice)"
                      :id="`choice_code_${choice.id}`"
                      v-model="choice.code"
                      :disabled="survey.isPublic">
             </b-input>
           </b-form-group>
    ...
    <div class="actions clearfix">
      ...
      <b-dropdown :no-caret="true"
        ...
        <b-dropdown-item @click="addDescription"
                         ...
                         class="no-icon"
                         :class="{ 'disabled': survey.isPublic }"> Add Description
        </b-dropdown-item>
