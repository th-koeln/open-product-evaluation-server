describe('Like Question', () => {
  ...
  it('Should change question value', function() {
    ...
    cy.get('.question:first-child input[id^=input_value]')
  ...
  it('Should add item to question', function() {
    ...
    cy.get('.question:first-child .question__new-item')
      .click()

    cy.wait(500)
      .get('.question:first-child .item__content')
      .its('length')
      .should('eq', 2)
  })
  ...
  it('Should change item value', function() {
    ...
    cy.get('.question:first-child .item:last-child input[id^=item_label]')
      .should('not.have.value', '')
      .clear()
      .type('new value')
  ...
  it('Should delete item from question', function() {
    ...
    cy.get('.question:first-child .item:last-child .item__delete')
      .click()
  ...
  it('Should move down question', function() {
    ...
    cy.get('.question:first-child .question__down')
      .click()
  ...
  it('Should move up question', function() {
    ...
    cy.get('.question:nth-child(2) .question__up')
      .click()
  ...
  it('Should append new question', function() {
    ...
    cy.get('.question:first-child .question__append')
      .click()
