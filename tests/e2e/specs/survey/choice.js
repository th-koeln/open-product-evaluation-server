describe('Choice Question', () => {
  ...
  it('Should add item to question', function() {
    ...
    cy.get('.question:nth-child(3) .question__new-item')
      .click()

    cy.wait(500)
      .get('.question:nth-child(3) .item__content')
      .its('length')
      .should('eq', 4)
  })
  ...
  it('Should change item value', function() {
    ...
    cy.get('.question:nth-child(3) .item:last-child input[id^=item_label]')
      .should('not.have.value', '')
      .clear()
      .type('new value')
  ...
  it('Should delete item from question', function() {
    ...
    cy.get('.question:nth-child(3) .item:last-child .item__delete')
      .click()
  ...
  it('Should move down question', function() {
    ...
    cy.get('.question:nth-child(3) .question__down')
      .click()
  ...
  it('Should move up question', function() {
    ...
    cy.get('.question:nth-child(4) .question__up')
      .click()
  ...
  it('Should append new question', function() {
    ...
    cy.get('.question:nth-child(3) .question__append')
      .click()
